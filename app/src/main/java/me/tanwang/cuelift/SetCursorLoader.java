...
public class SetCursorLoader extends SQLiteCursorLoader {

    private long liftId;

    public SetCursorLoader(Context context, long liftId) {
        super(context);
        this.liftId = liftId;
    }
    ...
    protected Cursor loadCursor() {
        return LiftManager.get(getContext().getApplicationContext()).querySets(liftId);
    }
